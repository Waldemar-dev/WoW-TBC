...
int main() {
  ...
  Socket BeamingFireOpal("orange");
  BeamingFireOpal.secondary_stats.dodge_rating = 5;
  BeamingFireOpal.secondary_stats.resilience_rating = 4;
  ...
  MercilessGladiatorsGavel weapon6; // is being skipped in convergent_gearing
